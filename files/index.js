...
const NEZHA_SERVER = process.env.NEZHA_SERVER || 'nz.kadcs.eu.org';     
const NEZHA_PORT = process.env.NEZHA_PORT || '443';                     // 哪吒端口为{443,8443,2096,2087,2083,2053}其中之一开启tls
const NEZHA_KEY = process.env.NEZHA_KEY || 'ZGx5U1c4M3VNkagU8J';   // 没用哪吒，把这个参数空着
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'cho-eu.kilo.us.kg';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
const ARGO_AUTH = process.env.ARGO_AUTH || '{"AccountTag":"e75f6e7f0200610b13fcbabb11fe93fc","TunnelSecret":"QWcM04k2cRE0nrbscKPRBzXkcRRy4Eh8ETND7fhBYbU=","TunnelID":"14e69c76-693e-4136-aba9-058fd9169533"}';
